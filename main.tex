...
\def\vUnterschriftKuest{images/UnterschriftPhilipp}                   %% Pfad zu Bild mit Unterschrift (für gedruckte Abgabe) Bsp.: images/Unterschrift2.png
...
%  \include{pages/abstract}
  ...
  \include{chapter/Toolauswahl1}
  \include{chapter/Qualitaetssicherung1}
  \include{chapter/Anforderungskonflikte1}
  \include{chapter/Stakeholderanalyse1}
  \include{chapter/EPK}
  \include{chapter/Kano_Model}
  \include{chapter/Stakeholderanalyse2}
  \include{chapter/EPK_Beispiel}
